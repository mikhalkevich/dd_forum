...
@section('content')
    ...
    <div class="v-category-show">
        ...
        @if ($category->accepts_threads)
                                ...
                                <transition name="fade">
                                    <div class="bg-white shadow-sm rounded-md" v-if="selectedThreads.length">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="text-end">
                                                <button type="submit" class="bg-green_bg border border-green_bg hover:bg-coin text-green_text px-3 py-2 rounded-md inline-block" @click="submit" :disabled="selectedAction == null">{{ trans('forum::general.proceed') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </transition>
            ...
            @else
                <div class="card my-3">
                    <div class="card-body text-gray-50">
