...
@section ('content')
    <div class="flex flex-row justify-between mb-2">
        <h2 class="text-3xl text-gray-50 font-medium my-3">{{ trans('forum::general.manage') }}</h2>
    ...
    <div class="v-manage-categories">
        ...
        <div class="flex justify-end py-3">
            <button type="button" class="bg-green_bg border border-green_bg hover:bg-coin text-green_text px-3 py-2 rounded-md inline-block" :disabled="isSavingDisabled" @click="onSave">
